...
public class RabbitMQMessageBroker : IMessageBroker, IDisposable
{
    ...
    private const string OrderCreatedExchange = "order.events";
    private const string OrderStatusChangedExchange = "order.events";
    ...
    public async Task SubscribeToPaymentEventsAsync()
    {
        ...
        paymentCompletedConsumer.Received += async (model, ea) =>
        {
            ...
            try
            {
                ...
                _logger.LogInformation("Received payment completed message: {Message}", message);
        ...
        _channel.QueueBind(paymentCompletedQueue, OrderCreatedExchange, "payments.paymentcompletedevent");
        ...
        _channel.QueueBind(paymentFailedQueue, OrderCreatedExchange, "payments.paymentfailedevent");
        ...
        _channel.QueueBind(paymentRefundedQueue, OrderCreatedExchange, "payments.paymentrefundedevent");
